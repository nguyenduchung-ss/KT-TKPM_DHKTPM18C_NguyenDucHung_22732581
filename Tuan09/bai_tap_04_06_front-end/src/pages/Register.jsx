...
const Register = () => {
  ...
  return (
    <div className="flex min-h-[calc(100vh-72px)] items-center justify-center p-6">
      <div className="relative w-full max-w-lg overflow-hidden rounded-[2rem] border border-white/70 bg-white/80 p-8 shadow-[0_30px_80px_rgba(88,58,24,0.18)] backdrop-blur">
        ...
        <div className="relative">
          <p className="mb-3 text-center text-xs font-black uppercase tracking-[0.28em] text-[#e75f35]">Join the trip</p>
          <h2 className="mb-2 text-center text-3xl font-black text-[#2f241d]">Tao tai khoan UniTour</h2>
          <p className="mb-7 text-center text-sm text-[#7a5b42]">Dang ky qua Orchestrator, User Service se tao tai khoan.</p>

          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              <label className="mb-1 block font-bold text-[#4b382d]">Ten dang nhap</label>
              <input
                type="text"
            ...
            <div>
              <label className="mb-1 block font-bold text-[#4b382d]">Ho va ten</label>
              <input
                type="text"
                className="w-full rounded-2xl border border-amber-900/10 bg-[#fff8ea] px-4 py-3 text-[#4b382d] outline-none transition focus:border-[#2f6f4e] focus:ring-4 focus:ring-[#2f6f4e]/15"
                value={fullName}
            ...
            <div>
              <label className="mb-1 block font-bold text-[#4b382d]">Email</label>
              <input
                type="email"
                className="w-full rounded-2xl border border-amber-900/10 bg-[#fff8ea] px-4 py-3 text-[#4b382d] outline-none transition focus:border-[#2f6f4e] focus:ring-4 focus:ring-[#2f6f4e]/15"
                value={email}
            ...
            {error ? <p className="rounded-2xl bg-red-50 px-4 py-3 text-sm font-semibold text-[#c2412d]">{error}</p> : null}
            {success ? <p className="rounded-2xl bg-emerald-50 px-4 py-3 text-sm font-semibold text-[#2f6f4e]">{success}</p> : null}
          ...
          <p className="mt-5 text-center text-sm font-semibold text-[#7a5b42]">
            Da co tai khoan?{' '}
            <Link to="/login" className="font-black text-[#2f6f4e] hover:text-[#24583e]">
              Dang nhap
            </Link>
          </p>
        </div>
